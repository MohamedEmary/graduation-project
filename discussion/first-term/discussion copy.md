---
title: \begin{title}\centering\vspace*{1cm}\rule{\textwidth}{0.05cm}\linebreak\vspace{0.5cm}{\huge\bfseries A Novel, High-Speed Encryption Algoritm with Polynomial Roots \par}\vspace{0.1cm}\hrule\end{title}
